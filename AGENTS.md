# Codex Context — BRKGA_FFT2

This file is automatically read by Codex at the start of every conversation. It gives you the full picture of what this project is, how to work on it, and how to run experiments autonomously on the remote GPU.
