...
class BuildingPlate:
    ...
    def can_insert(self, part, machPart, plott=False):
        ...
        if result == True:
            ...
            self.insert(best_pixel[0], best_pixel[1], part_rotations[best_rotation], part_shapes[best_rotation], part.area)
            ...
            self.processingTimeHeight = max(self.processingTimeHeight, machPart.proc_time_height)
